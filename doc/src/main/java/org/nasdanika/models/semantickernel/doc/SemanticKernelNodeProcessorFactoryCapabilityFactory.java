...
public class SemanticKernelNodeProcessorFactoryCapabilityFactory implements CapabilityFactory<NodeProcessorFactoryRequirement, Object> {
	...
	private Iterable<CapabilityProvider<Object>> createFactory(
		...
		SemanticKernelNodeProcessorFactory factory = new SemanticKernelNodeProcessorFactory(
				requirement.context(), 
