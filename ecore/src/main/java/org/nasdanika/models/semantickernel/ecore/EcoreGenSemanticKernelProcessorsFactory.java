package org.nasdanika.models.semantickernel.ecore;
...
@EPackageNodeProcessorFactory(nsURI = SemantickernelPackage.eNS_URI)
public class EcoreGenSemanticKernelProcessorsFactory {
...
//	public final CrewProcessorsFactory crewProcessorsFactory;
	...
	public EcoreGenSemanticKernelProcessorsFactory(Context context) {
		this.context = context;
//		crewProcessorsFactory = new CrewProcessorsFactory(context);		
	}
	
	@EPackageNodeProcessorFactory(
			label = "Semantic Kernel Model",
			icon = "https://semantic-kernel.models.nasdanika.org/images/semantic-kernel.png",
...
//						}),
					...
					Files.writeString(new File("target/semantic-kernel.drawio").toPath(), document.save(null));
				} catch (Exception e) {
					e.printStackTrace();
