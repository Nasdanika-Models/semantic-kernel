...
public class ECoreGenSemanticKernelProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenSemanticKernelProcessorsFactory(requirement.requirement().context()))));
	}
